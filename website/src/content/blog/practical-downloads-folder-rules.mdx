...
When a rule gets something wrong in public version 0.1.6, open History and undo the move. Then use the row-level toggle to disable the rule while you adjust its pattern.
