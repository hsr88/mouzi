...
The current public 0.1.5 Windows files are unsigned and may show **Windows protected your PC**. Only continue if the file came from [mouzi.cc](/download/windows) or the official [GitHub release](https://github.com/hsr88/mouzi/releases).
