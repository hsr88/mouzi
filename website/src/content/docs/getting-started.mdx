...
In Silent mode, Mouzi waits for the configured grace period and then moves the file. In Manual mode, choose **Organize now**. The result will look like `Documents/2026/08/report.pdf`.
